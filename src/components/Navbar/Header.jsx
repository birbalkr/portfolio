...
function Header() {
    ...
    return (
        <nav className="relative bg-white shadow dark:bg-background">
            <div className="container px-6 py-4 mx-auto">
                <div className="lg:flex lg:items-center lg:justify-between">
                    <div className="flex items-center justify-between">
                        <Link href="/">
                            <p
                                className="w-auto h-6 sm:h-7 text-2xl text-title font-extrabold"
                            >
                                PortFolio
                            </p>
                        </Link>
                    ...
                    {/* Menu */}
                    <div
                        className={`absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-background lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center ${isOpen ? 'translate-x-0 opacity-100' : 'opacity-0 -translate-x-full'
                            }`}
                    >
                        <div className="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                            ...
                            <Link to="https://portfolio-blogs.netlify.app/" className="px-3 py-2 mx-3 mt-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md lg:mt-0">
                                Blogs
                            </Link>
